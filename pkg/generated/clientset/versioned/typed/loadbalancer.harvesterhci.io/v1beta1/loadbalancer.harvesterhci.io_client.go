...
func (c *LoadbalancerV1beta1Client) IPPools() IPPoolInterface {
	return newIPPools(c)
}
...
// NewForConfigAndClient creates a new LoadbalancerV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*LoadbalancerV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := loadbalancerharvesterhciiov1beta1.SchemeGroupVersion
